      ...
      <section className="pb-8 md:pb-12 px-5 md:px-8">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="flex justify-center mt-6 md:mt-8">
            <Link to="/book" className="bg-[#3b6fe8] hover:bg-[#3b6fe8]/90 text-white px-8 py-3.5 md:py-4 rounded-xl text-[15px] md:text-[16px] font-bold shadow-[0_0_30px_rgba(59,111,232,0.2)] transition-all hover:scale-[1.02]">
      ...
      <section className="pt-8 pb-16 md:pb-24 px-5 md:px-8 flex flex-col items-center">
        <div className="max-w-[960px] mx-auto w-full">
          <div className="bg-[#0b0d22] border border-[#3b6fe8]/[0.32] rounded-[24px] p-8 md:p-[64px_56px] text-center shadow-[0_0_80px_rgba(59,111,232,0.08)] relative overflow-hidden flex flex-col items-center">
            ...
            <Link to="/book" className="bg-[#3b6fe8] hover:scale-[1.02] transition-transform duration-200 text-white text-center py-4 md:py-5 px-8 md:px-12 rounded-[12px] text-[16px] md:text-[17px] font-bold shadow-[0_0_40px_rgba(59,111,232,0.22)] w-full sm:w-auto inline-block">
